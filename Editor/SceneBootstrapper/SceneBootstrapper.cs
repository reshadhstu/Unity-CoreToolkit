...
namespace CoreToolkit.Editor.SceneBootstrapper
{
	/// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        [MenuItem(k_LoadBootstrapMenu, priority = 31)]
        ...
        [MenuItem(k_LoadBootstrapMenu, true, 32)]
        ...
        [MenuItem(k_DontLoadBootstrapMenu, priority = 33)]
        ...
        [MenuItem(k_DontLoadBootstrapMenu, true, 34)]
