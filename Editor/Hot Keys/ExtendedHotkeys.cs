...
namespace CoreToolkit.Editor.Hot_Keys
{
    public static class ExtendedHotkeys
    {
        ...
        [MenuItem("Tools/Select GameConfig %_T", false, 0)]
        ...
        [MenuItem("Tools/Select GameManager %_G", false, 1)]
        ...
        [MenuItem("Tools/Toggle Inspector Lock _F3", false, 2)]
        ...
        [MenuItem("Tools/Toggle Enter Play Mode Options _F4", false, 3)]
